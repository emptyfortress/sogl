...
const list = [
	...
	{id: 2, group: 'date', label: '13\nноября', fixed: true, },
	{id: 3, group: 'date', label: '15\nноября', fixed: true, },
	{id: 4, group: 'date', label: '16\nноября', fixed: true, },
	{id: 5, group: 'date', label: '18\nноября', fixed: true, },
	{id: 6, group: 'date', label: '19\nноября', fixed: true, },
	{id: 7, group: 'date', label: '20\nноября', fixed: true, },
	{id: 8, group: 'date', label: '20\nноября', fixed: true, },
	{id: 9,  group: 'flag', label: 'Старт', fixed: { x: true } },
	{id: 10, group: 'finished', label: 'Согласование\nс производством',  fixed: { x: true } },
	{id: 11, group: 'finished', label: 'Юридический отдел', fixed: { x: true } },
	{id: 12, group: 'finished', label: 'Финансовый отдел', fixed: { x: true } },
	{id: 13, group: 'finished', label: 'Плановый отдел', fixed: { x: true } },
	{id: 14, group: 'overdue', label: 'Консолидация', fixed: { x: true } },
	{id: 15, group: 'current', label: 'Согласование\nс акционерами',  fixed: { x: true } },
	{id: 16, group: 'notStart', label: 'Подписание', fixed: { x: true } },
	{id: 17, group: 'notStart', label: 'Регистрация\nв реестре',  fixed: { x: true } },
